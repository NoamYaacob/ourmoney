// VISUAL-QA ONLY. Never imported by the app; swapped in for
// lib/supabase/client.ts by a temporary metro resolver when QA_FIXTURES=1,
// so authenticated screens can be rendered and screenshotted in a browser.
...
const SESSION = {
  access_token: 'qa', refresh_token: 'qa', expires_in: 3600, token_type: 'bearer',
