...
const DEFAULT_RECURRING = { recurringTransactions: [] as unknown[], isLoading: false, error: null as Error | null }
...
const DEFAULT_INSTALLMENT_PLANS = { plans: [] as unknown[], isLoading: false, error: null as Error | null }
