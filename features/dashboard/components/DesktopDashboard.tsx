// The desktop dashboard, extracted verbatim from app/(app)/dashboard/
// index.tsx when Mobile got its own composition. Not restyled and not
// rearranged: this layout is the approved desktop design, and the mobile
// redesign's brief was explicit that it stays that way.
//
// It renders only at >=1200px on web — app/(app)/dashboard/index.tsx picks
// between this and MobileHome — so every `web:desktop:` qualifier inside
// is now belt-and-braces rather than the mechanism. They are left in place
