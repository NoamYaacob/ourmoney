// The desktop transactions screen, extracted verbatim from
// app/(app)/transactions/index.tsx when Mobile got its own composition. Not
// restyled and not rearranged: this layout is the approved desktop design,
// and its permanently-visible filter row is correct at a width that has the
// space for it.
//
// It renders only at >=1200px on web — app/(app)/transactions/index.tsx
// picks between this and MobileTransactions.
